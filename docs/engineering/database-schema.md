...
## Author’s Notes & Considerations

The schema was derived from the original Figma designs and the v1 product spec, focusing on the Prisma operations most natural for creating courses, skill trees, skill nodes, lesson blocks, quizzes, and users.
