...
import LearnerXpRail from "../components/LearnerXpRail";
...
export default function Home() {
  ...
  return (
    // Right rail with today's goal and this week's XP (SYN-50). Below lg it
    // stacks under the main column.
    <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-10 sm:py-14 lg:grid-cols-[1fr_320px] lg:items-start">
      <div className="flex min-w-0 flex-col items-center gap-10 text-center">
      ...
      <aside aria-label="Your progress" className="lg:sticky lg:top-24">
        <LearnerXpRail />
      </aside>
    </div>
  );
