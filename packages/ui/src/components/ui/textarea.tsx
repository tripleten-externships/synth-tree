...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  (props, ref) => {
    ...
    const [dragStartTime, setDragStartTime] = React.useState<number | null>(
      null
    );
    ...
    const [dragLabelDimensions, setDragLabelDimensions] = React.useState<{
      width: number;
      height: number;
    } | null>(null);
    ...
    const handleResizeStart = React.useCallback(
      (e: React.MouseEvent, direction: ResizeDirection) => {
        ...
        const handleMouseMove = (moveEvent: MouseEvent) => {
          if (!textareaContainerRef.current || !initialResizeBoundsRef.current)
            return;
    ...
    React.useEffect(() => {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        if (isDraggingActive && isSustainedClick) {
          ...
          const parentRect =
            textareaContainerRef.current?.parentElement?.getBoundingClientRect();
          ...
          if (dragData) {
            ...
            const currentMouseAngle =
              (Math.atan2(
                e.clientY - dragData.centerY,
                e.clientX - dragData.centerX
              ) *
                180) /
              Math.PI;
        ...
        >
          ...
          <div
            className={cn(
              ...
              hoveredResizeEdge.indexOf("north") !== -1 &&
                !isTextareaFocused &&
                "textarea-field__resize-edge--hovered border-t-2 border-ring"
            )}
            style={
              hoveredResizeEdge.indexOf("north") !== -1 && !isTextareaFocused
                ? {
                    top: "2px",
                    left: "2px",
                    right: "2px",
          ...
          <div
            className={cn(
              ...
              hoveredResizeEdge.indexOf("east") !== -1 &&
                !isTextareaFocused &&
                "textarea-field__resize-edge--hovered border-r-2 border-ring"
            )}
            style={
              hoveredResizeEdge.indexOf("east") !== -1 && !isTextareaFocused
                ? {
                    top: "2px",
                    right: "2px",
                    bottom: "2px",
          ...
          <div
            className={cn(
              ...
              hoveredResizeEdge.indexOf("south") !== -1 &&
                !isTextareaFocused &&
                "textarea-field__resize-edge--hovered border-b-2 border-ring"
            )}
            style={
              hoveredResizeEdge.indexOf("south") !== -1 && !isTextareaFocused
                ? {
                    bottom: "2px",
                    left: "2px",
                    right: "2px",
          ...
          <div
            className={cn(
              ...
              hoveredResizeEdge.indexOf("west") !== -1 &&
                !isTextareaFocused &&
                "textarea-field__resize-edge--hovered border-l-2 border-ring"
            )}
            style={
              hoveredResizeEdge.indexOf("west") !== -1 && !isTextareaFocused
                ? {
                    top: "2px",
                    left: "2px",
                    bottom: "2px",
